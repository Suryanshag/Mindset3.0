...
export default function EditNgoVisitPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.success) router.push('/admin/ngo')
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Edit NGO Visit</h1>
